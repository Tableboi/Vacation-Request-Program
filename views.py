    ...
    def search_emp(self):        
        ...
        for i in range(0, row_len, 1):
            ...
            if entry_list[i][11]:
                ...
                print(Controller.stell_info_formatted)
...
class request_window(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        self.stellvertreter_combo = ttk.Combobox(self.same_last_name, textvariable = self.stellvertreter_selection)
    ...
    def submit(self):
        ...
        if gründe == 1:
            ...
            output = sonderurlaub
        if output == '':
            Controller.error_window(self, 'Please enter a reason for Sonderurlaub.')
            return
        else:
            print('Ä')
            ...
            if self.stell_entry.get() != '':
                ...
                if len(Controller.stellvertreter_values) != 0:
                    ...
                    print(Controller.stellvertreter_info)
    ...
    def stell_combo_handler(self, event = None):
        ...
        print(Controller.stellvertreter_info[stell_index])
